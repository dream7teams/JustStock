...
public class AdminSignalMessageServiceImpl implements AdminSignalMessageService {
    ...
    @Override
    public Optional<AdminSignalMessage> getOne(SignalType signalType, InstrumentType instrumentType) {
        return repo.findBySignalTypeAndInstrumentType(signalType, instrumentType);
    }
}
